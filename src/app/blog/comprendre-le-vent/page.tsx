...
export const metadata: Metadata = {
  title: "Comprendre le Vent en Char à Voile | Glisse et Vent",
  description: "Apprenez les secrets du vent pour le char à voile : allures, vent réel vs vent apparent, et comment lire la plage pour anticiper rafales et molles.",
};
          ...
          <div className="prose prose-xl max-w-none mx-auto text-foreground space-y-6 text-xl">
            ...
            <section>
              <Card className="bg-card">
                <CardHeader>
                  <CardTitle as="h2" className="text-2xl flex items-center gap-2"><Compass className="w-6 h-6"/>Les Allures : Votre Rapport au Vent</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <section>
              <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl flex items-center gap-2"><Wind className="w-6 h-6"/>Vent Réel vs. Vent Apparent</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">Lire la Plage : Rafales et Molles</CardTitle></CardHeader>
                  <CardContent>
