  ...
  return (
    <html lang="fr">
      <head>
        ...
        <meta name="keywords" content="char à voile, denneville, glisse, vent, école de voile, sport de plage, normandie, cotentin, activité de groupe, séminaire" />
        ...
        <meta property="og:url" content="https://www.glisseetvent.com" />
