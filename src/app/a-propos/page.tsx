...
const monitors = [
  ...
  {
    name: "Claire",
    role: "Monitrice & Spécialiste Vitesse",
        ...
        <Card>
          ...
          <CardContent className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2 h-64 md:h-80 relative rounded-lg overflow-hidden">
              <Image src="https://placehold.co/800x600.png" alt="Char à voile au coucher du soleil" layout="fill" objectFit="cover" data-ai-hint="sailing sunset" />
            </div>
          </CardContent>
        </Card>
            ...
            {monitors.map(monitor => (
              <div key={monitor.name} className="flex flex-col sm:flex-row gap-6 items-center">
                <div className="w-32 h-32 relative rounded-full overflow-hidden shrink-0">
                  <Image src={monitor.image} alt={`Portrait de ${monitor.name}`} layout="fill" objectFit="cover" data-ai-hint={monitor.hint} />
                </div>
