...
export function ContactCard({ className, showLink }: { className?: string, showLink?: boolean }) {
  ...
  if (showLink) {
    return (
       <Card className={cn("flex flex-col justify-between text-center", className)}>
        <CardHeader>
        ...
        <CardContent>
             <p className="text-muted-foreground mb-4 text-xl">
                Nous sommes à votre disposition pour toute demande d'information ou de réservation.
            </p>
