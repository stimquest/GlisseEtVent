...
// import { SubtleDotsOverlay } from "./subtle-dots-overlay"; // Supprimé - overlay ne fonctionne pas
    ...
    <Card className={cn("w-full h-[80vh] min-h-[60vh] md:h-[55vh] lg:h-[75vh] overflow-hidden relative text-white", className)}>
        <div className="absolute inset-0 z-0">
            <video
              ...
              poster="/img/hero.png"
            >
              <source src="/media/GV01.mp4" type="video/mp4" />
              Votre navigateur ne supporte pas la vidéo.
            </video>
        </div>

        {/* Overlay discret de points - Supprimé car ne fonctionne pas */}
        {/* <SubtleDotsOverlay /> */}
