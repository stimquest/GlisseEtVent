...
export const metadata: Metadata = {
  title: "Denneville-Plage : Le Spot Idéal pour le Char à Voile | Glisse et Vent",
  description: "Découvrez pourquoi Denneville-Plage est le lieu parfait pour le char à voile : une plage immense, un sable dur idéal pour la glisse et des vents réguliers.",
};
      ...
      <main className="flex-grow p-4 sm:p-6 md:p-8">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="relative h-64 md:h-96 w-full rounded-lg overflow-hidden mb-8">
            <Image 
              src="/img/Blog/Art-spot.jpg" 
              alt="Vaste plage de sable de Denneville à marée basse, idéale pour le char à voile" 
              fill
          ...
          <div className="prose prose-xl max-w-none mx-auto text-foreground space-y-6 text-xl">
            ...
            <section>
              <Card className="bg-card">
                <CardHeader>
                  <CardTitle as="h2" className="text-2xl flex items-center gap-2"><Waves className="w-6 h-6"/>Une Plage à l'Infinie (ou presque)</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <section>
              <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">Un Sable Parfait pour la Glisse</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">Des Vents Réguliers</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl flex items-center gap-2"><Mountain className="w-6 h-6"/>Un Cadre Naturel Préservé</CardTitle></CardHeader>
                  <CardContent>
