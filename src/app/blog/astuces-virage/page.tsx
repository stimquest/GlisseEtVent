...
export const metadata: Metadata = {
  title: "5 Astuces pour Maîtriser votre Virage en Char à Voile | Glisse et Vent",
  description: "Devenez un pro du virage en char à voile grâce à 5 astuces de nos moniteurs. Apprenez à gérer votre regard, la voile, le palonnier et le poids de votre corps.",
};
      ...
      <main className="flex-grow p-4 sm:p-6 md:p-8">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="relative h-64 md:h-96 w-full rounded-lg overflow-hidden mb-8">
            <Image 
              src="/img/Blog/Art2.jpg" 
              alt="Char à voile prenant un virage serré sur une plage de sable" 
              fill
          ...
          <div className="prose prose-xl max-w-none mx-auto text-foreground space-y-6 text-xl">
            ...
            <section>
              <Card className="bg-card">
                <CardHeader>
                  <CardTitle as="h2" className="text-2xl">1. Le Regard est la Clé</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <section>
              <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">2. Anticipez la Pression de la Voile</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">3. Action Coordonnée : Palonnier et Écoute</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">4. Utilisez le Poids de votre Corps</CardTitle></CardHeader>
                  <CardContent>
            ...
            <section>
               <Card className="bg-card">
                  <CardHeader><CardTitle as="h2" className="text-2xl">5. La Pratique sur un Grand Espace</CardTitle></CardHeader>
                  <CardContent>
